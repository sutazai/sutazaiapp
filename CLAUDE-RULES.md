# Critical Rules (VERIFIED 2025-08-21)
...
MANDATORY FIRST STEP: Read and review CHANGELOG.md thoroughly—it contains the complete change history. Include a CHANGELOG.md in every important directory for easy reference and visibility into overall system status
There should be an index that includes references to all CHANGELOG.md files for easy access
...
also do not make any chnages to /opt/sutazaiapp/.claude/agents unless i ask to 
