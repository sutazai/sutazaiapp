    ...
    async def _assess_control(self, control: ComplianceControl) -> AssessmentResult:
        ...
        try:
            ...
            return AssessmentResult(
                ...
                notes=f"Automated assessment completed at {datetime.utcnow()}"
            )
            ...
            for result in report.results:
                cursor.execute("""
                    ...
                    (report_id, control_id, status, assessment_date, assessor,
                     findings, evidence_ids, remediation_required, remediation_timeline, notes)
                ...
                """, (
                    ...
                    result.remediation_timeline, result.notes
                ))
