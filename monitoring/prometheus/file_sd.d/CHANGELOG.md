...
All notable changes to the Service Discovery Configuration module will be documented in this file.
...
### Added
- Initial service discovery configuration implementation
