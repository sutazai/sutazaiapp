...
class RequirementsConsolidator:
    ...
    def write_consolidated(self):
        ...
        print(f"✅ Frontend requirements already consolidated at frontend/requirements.txt")
    ...
    def cleanup_duplicates(self):
        ...
        print("\n📋 Duplicate requirements files that can be removed:")
        ...
        print("\n⚠️  Run these commands manually after verifying consolidated files work")
