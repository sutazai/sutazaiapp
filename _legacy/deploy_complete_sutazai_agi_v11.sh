...
create_backup_system() {
    ...
    cat > /opt/sutazaiapp/scripts/backup_system.sh << 'EOF'
#!/bin/bash
...
EOF
    ...
    (crontab -l 2>/dev/null; echo "0 2 * * * /opt/sutazaiapp/scripts/backup_system.sh >> /opt/sutazaiapp/data/logs/backup.log 2>&1") | crontab -
