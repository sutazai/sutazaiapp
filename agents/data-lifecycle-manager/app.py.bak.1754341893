...
class Data_Lifecycle_ManagerAgent(BaseAgentV2):
    """Agent implementation for data-lifecycle-manager"""
    
    def __init__(self):
        super().__init__(
            agent_id="data-lifecycle-manager",
...
if __name__ == "__main__":
    agent = Data_Lifecycle_ManagerAgent()
    agent.start()
