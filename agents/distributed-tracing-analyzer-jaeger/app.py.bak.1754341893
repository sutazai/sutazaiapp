...
class Distributed_Tracing_Analyzer_JaegerAgent(BaseAgentV2):
    """Agent implementation for distributed-tracing-analyzer-jaeger"""
    
    def __init__(self):
        super().__init__(
            agent_id="distributed-tracing-analyzer-jaeger",
...
if __name__ == "__main__":
    agent = Distributed_Tracing_Analyzer_JaegerAgent()
    agent.start()
