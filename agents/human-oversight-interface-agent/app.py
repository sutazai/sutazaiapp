...
class Human_Oversight_Interface_AgentAgent(BaseAgentV2):
    """Agent implementation for human-oversight-interface-agent"""
    
    def __init__(self):
        super().__init__(
            agent_id="human-oversight-interface-agent",
...
if __name__ == "__main__":
    agent = Human_Oversight_Interface_AgentAgent()
    agent.start()
