...
class Ram_Hardware_OptimizerAgent(BaseAgentV2):
    """Agent implementation for ram-hardware-optimizer"""
    
    def __init__(self):
        super().__init__(
            agent_id="ram-hardware-optimizer",
...
if __name__ == "__main__":
    agent = Ram_Hardware_OptimizerAgent()
    agent.start()
