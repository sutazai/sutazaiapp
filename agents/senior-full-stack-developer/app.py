...
class Senior_Full_Stack_DeveloperAgent(BaseAgentV2):
    """Agent implementation for senior-full-stack-developer"""
    
    def __init__(self):
        super().__init__(
            agent_id="senior-full-stack-developer",
...
if __name__ == "__main__":
    agent = Senior_Full_Stack_DeveloperAgent()
    agent.start()
