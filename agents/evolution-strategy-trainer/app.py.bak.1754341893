...
class Evolution_Strategy_TrainerAgent(BaseAgentV2):
    """Agent implementation for evolution-strategy-trainer"""
    
    def __init__(self):
        super().__init__(
            agent_id="evolution-strategy-trainer",
...
if __name__ == "__main__":
    agent = Evolution_Strategy_TrainerAgent()
    agent.start()
