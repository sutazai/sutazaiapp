...
class Ai_Senior_Full_Stack_DeveloperAgent(BaseAgentV2):
    """Agent implementation for ai-senior-full-stack-developer"""
    
    def __init__(self):
        super().__init__(
            agent_id="ai-senior-full-stack-developer",
...
if __name__ == "__main__":
    agent = Ai_Senior_Full_Stack_DeveloperAgent()
    agent.start()
