...
class Deep_Learning_Brain_ManagerAgent(BaseAgentV2):
    """Agent implementation for deep-learning-brain-manager"""
    
    def __init__(self):
        super().__init__(
            agent_id="deep-learning-brain-manager",
...
if __name__ == "__main__":
    agent = Deep_Learning_Brain_ManagerAgent()
    agent.start()
