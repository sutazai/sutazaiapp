...
class Observability_Dashboard_Manager_GrafanaAgent(BaseAgentV2):
    """Agent implementation for observability-dashboard-manager-grafana"""
    
    def __init__(self):
        super().__init__(
            agent_id="observability-dashboard-manager-grafana",
...
if __name__ == "__main__":
    agent = Observability_Dashboard_Manager_GrafanaAgent()
    agent.start()
