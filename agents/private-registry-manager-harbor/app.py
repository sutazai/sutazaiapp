...
class Private_Registry_Manager_HarborAgent(BaseAgentV2):
    """Agent implementation for private-registry-manager-harbor"""
    
    def __init__(self):
        super().__init__(
            agent_id="private-registry-manager-harbor",
...
if __name__ == "__main__":
    agent = Private_Registry_Manager_HarborAgent()
    agent.start()
