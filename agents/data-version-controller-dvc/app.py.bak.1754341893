...
class Data_Version_Controller_DvcAgent(BaseAgentV2):
    """Agent implementation for data-version-controller-dvc"""
    
    def __init__(self):
        super().__init__(
            agent_id="data-version-controller-dvc",
...
if __name__ == "__main__":
    agent = Data_Version_Controller_DvcAgent()
    agent.start()
