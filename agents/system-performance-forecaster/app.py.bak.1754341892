...
class System_Performance_ForecasterAgent(BaseAgentV2):
    """Agent implementation for system-performance-forecaster"""
    
    def __init__(self):
        super().__init__(
            agent_id="system-performance-forecaster",
...
if __name__ == "__main__":
    agent = System_Performance_ForecasterAgent()
    agent.start()
