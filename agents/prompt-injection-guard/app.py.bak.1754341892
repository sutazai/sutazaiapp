...
class Prompt_Injection_GuardAgent(BaseAgentV2):
    """Agent implementation for prompt-injection-guard"""
    
    def __init__(self):
        super().__init__(
            agent_id="prompt-injection-guard",
...
if __name__ == "__main__":
    agent = Prompt_Injection_GuardAgent()
    agent.start()
