...
class Neural_Architecture_SearchAgent(BaseAgentV2):
    """Agent implementation for neural-architecture-search"""
    
    def __init__(self):
        super().__init__(
            agent_id="neural-architecture-search",
...
if __name__ == "__main__":
    agent = Neural_Architecture_SearchAgent()
    agent.start()
