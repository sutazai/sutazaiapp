...
class Ai_Senior_Backend_DeveloperAgent(BaseAgentV2):
    """Agent implementation for ai-senior-backend-developer"""
    
    def __init__(self):
        super().__init__(
            agent_id="ai-senior-backend-developer",
...
if __name__ == "__main__":
    agent = Ai_Senior_Backend_DeveloperAgent()
    agent.start()
