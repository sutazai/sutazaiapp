...
# Agent Registry - Updated with all running agents
AGENT_REGISTRY = {
    "letta": {
        "name": "Letta (MemGPT)",
    ...
    "langchain": {
        "name": "LangChain",
        "capabilities": ["llm-framework", "chain-of-thought", "agents"],
        "port": 11405,
        "status": "offline"
    },
    "bigagi": {
        "name": "BigAGI",
        "capabilities": ["chat-interface", "multi-model", "reasoning"],
        "port": 11407,
        "status": "offline"
    },
    "agentzero": {
        "name": "Agent Zero",
        "capabilities": ["autonomous", "task-completion", "reasoning"],
        "port": 11408,
        "status": "offline"
    },
    "skyvern": {
    ...
    "shellgpt": {
        "name": "ShellGPT",
        "capabilities": ["cli-assistant", "command-generation", "terminal"],
        "port": 11413,
        "status": "offline"
    },
    "autogen": {
        "name": "AutoGen",
        "capabilities": ["multi-agent", "conversation", "configuration"],
        "port": 11415,
        "status": "offline"
    },
    "browseruse": {
        "name": "Browser Use",
        "capabilities": ["web-automation", "browser-control", "scraping"],
        "port": 11703,
        "status": "offline"
    },
    "semgrep": {
        "name": "Semgrep",
        "capabilities": ["security-analysis", "code-scanning", "vulnerability-detection"],
        "port": 11801,
        "status": "offline"
    }
}
