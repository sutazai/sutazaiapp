...
class RomanceConfiguration:
    ...
    love_language_weights: Dict[str, float] = field(default_factory=lambda: {
    ...
    relational_guidelines: Dict[str, bool] = field(default_factory=lambda: {
...
class RomanceIntelligenceEngine:
    ...
    def _process_emotional_depth(
        ...
        try:
            ...
            return {
                'empathy': emotional_depth.get('empathy', 0) * self.config.empathy_level,
                'vulnerability': emotional_depth.get('vulnerability', 0),
                'emotional_intelligence': emotional_depth.get('emotional_intelligence', 0)
            }
        except Exception as e:
