# Hygiene Suite Report - 20250807_203400
Overall: ❌ FAIL
...
Rule 3: Codebase Hygiene: 20% ❌ FAIL
  Issues found:
    - Too many docker-compose files: 3 (max 2)
    - Too many scripts: 396 (max 50)
    - Too many documentation files: 945 (max 50)
    - Found 2 junk files
...
Rule 4: Reuse Before Creating: 55% ❌ FAIL
  Issues found:
    ...
    - Potential duplicates: 40 files matching requirements*.txt
