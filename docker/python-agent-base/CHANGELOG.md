# CHANGELOG - python-agent-base

- **Location**: `/opt/sutazaiapp/docker/python-agent-base`
- **Purpose**: Docker configurations and containers - python-agent-base subdirectory
