# CHANGELOG - extended-memory-persistent

- **Location**: `/opt/sutazaiapp/docker/mcp-services/extended-memory-persistent`
- **Purpose**: Directory for extended-memory-persistent related files and resources
