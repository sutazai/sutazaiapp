# CHANGELOG - monitoring-secure

- **Location**: `/opt/sutazaiapp/docker/monitoring-secure`
- **Purpose**: Docker configurations and containers - monitoring-secure subdirectory
