# CHANGELOG - blackbox-exporter

- **Location**: `/opt/sutazaiapp/docker/monitoring-secure/blackbox-exporter`
- **Purpose**: Directory for blackbox-exporter related files and resources
