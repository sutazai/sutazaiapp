# CHANGELOG - docker-engine

- **Location**: `/opt/sutazaiapp/docker/01-foundation-tier-0/docker-engine`
- **Purpose**: Directory for docker-engine related files and resources
