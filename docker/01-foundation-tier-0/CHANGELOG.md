# CHANGELOG - 01-foundation-tier-0

- **Location**: `/opt/sutazaiapp/docker/01-foundation-tier-0`
- **Purpose**: Docker configurations and containers - 01-foundation-tier-0 subdirectory
