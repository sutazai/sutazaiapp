                                            ...
                                            if line and not line.startswith(
                                                ...
                                                if package:
                                                    ...
                                                    "total_required": len(
                                                        required_packages),
                                                    "installed": len(
                                                        required_packages) - len(missing_packages),
                                                    ...
                                                    def install_missing_dependencies(
                                                        ...
                                                        for dep, info in system_deps.items():
                                                            if info.get(
                                                                "installed") is False:
                                                                logger.info(
                                                                    "System dependency %s needs to be installed manually",
                                                                    dep)
                                                                ...
                                                                if missing_packages:
                                                                    ...
                                                                    return True
                                                                        ...
                                                                        logger.error(
                                                                            "Failed to install Python packages: %s",
                                                                            e)
                                                                    return False
                                                                ...
                                                                def setup_system(
                                                                    ...
                                                                    if not self.validate_python_version():
                                                                        ...
                                                                        # Install missing dependencies
                                                                        if any(
                                                                            info.get("status") != "OK" for info in dependencies.values()):
                                                                            ...
                                                                            def run_maintenance(
                                                                                ...
                                                                                report_dir,
                                                                                f"maintenance_report_{datetime.now(
