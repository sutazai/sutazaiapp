# CHANGELOG - rules-security-review

- **Location**: `/opt/sutazaiapp/.roo/rules-security-review`
- **Purpose**: Directory for rules-security-review related files and resources
