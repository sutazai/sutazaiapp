# CHANGELOG - rules-spec-pseudocode

- **Location**: `/opt/sutazaiapp/.roo/rules-spec-pseudocode`
- **Purpose**: Directory for rules-spec-pseudocode related files and resources
