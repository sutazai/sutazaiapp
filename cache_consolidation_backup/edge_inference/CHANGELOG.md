# CHANGELOG - edge_inference

- **Location**: `/opt/sutazaiapp/cache_consolidation_backup/edge_inference`
- **Purpose**: Directory for edge_inference related files and resources
