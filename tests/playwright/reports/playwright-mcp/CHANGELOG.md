# CHANGELOG - playwright-mcp

- **Location**: `/opt/sutazaiapp/tests/playwright/reports/playwright-mcp`
- **Purpose**: Directory for playwright-mcp related files and resources
