...
class TestRedisConnection:
    ...
    @patch('app.mesh.redis_bus.redis.ConnectionPool.from_url')
    @patch('app.mesh.redis_bus.redis.Redis')
...
class TestStreamKeys:
    ...
    def test_task_stream_key(self):
        ...
        from app.mesh.redis_bus import task_stream
    ...
    def test_result_stream_key(self):
        ...
        from app.mesh.redis_bus import result_stream
    ...
    def test_dead_stream_key(self):
        ...
        from app.mesh.redis_bus import dead_stream
    ...
    def test_agent_key(self):
        ...
        from app.mesh.redis_bus import agent_key
...
class TestAgentRegistry:
    ...
    def test_heartbeat_agent_exists(self, mock_get_redis, mock_redis):
        ...
        from app.mesh.redis_bus import heartbeat_agent
    ...
    def test_list_agents_empty(self, mock_get_redis, mock_redis):
        ...
        from app.mesh.redis_bus import list_agents
...
class TestConsumerGroups:
    ...
    def test_create_consumer_group(self, mock_get_redis, mock_redis):
        ...
        from app.mesh.redis_bus import create_consumer_group
    ...
    def test_read_group_empty(self, mock_get_redis, mock_redis):
        ...
        from app.mesh.redis_bus import read_group
    ...
    def test_ack_message(self, mock_get_redis, mock_redis):
        ...
        from app.mesh.redis_bus import ack
...
class TestDeadLetterQueue:
    ...
    def test_move_to_dead(self, mock_get_redis, mock_redis, sample_task_payload):
        ...
        from app.mesh.redis_bus import move_to_dead
...
class TestPerformanceOptimizations:
    ...
    def test_connection_pool_settings(self):
        ...
        with patch('app.mesh.redis_bus.redis.ConnectionPool.from_url') as mock_pool:
            with patch('app.mesh.redis_bus.redis.Redis') as mock_redis_class:
    ...
    def test_get_redis_async_creates_pool(self):
        ...
        with patch('app.mesh.redis_bus.redis_async.ConnectionPool.from_url') as mock_pool:
            with patch('app.mesh.redis_bus.redis_async.Redis') as mock_redis_class:
                # Reset global async pool
                import app.mesh.redis_bus
                app.mesh.redis_bus._redis_async_pool = None
                
                import asyncio
                async def test_async():
                    from app.mesh.redis_bus import get_redis_async
...
class TestErrorHandling:
    ...
    def test_empty_topic_handling(self):
        ...
        from app.mesh.redis_bus import task_stream, result_stream, dead_stream
