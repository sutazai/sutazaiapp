...
class TestAutoRemediationIntegration(unittest.TestCase):
    ...
    def test_custom_remediation_script_integration(self):
        ...
        custom_script_path = os.path.join(self.test_project_dir, 'test_remediation_script.py')
...
''')
        ...
        remediation_actions = self.remediation_manager.analyze_security_report(mock_security_report)
        results = self.remediation_manager.execute_remediation_actions(remediation_actions)
    ...
    def test_custom_remediation_script_failure(self):
        ...
        """
        # Create a temporary custom remediation script
        custom_script_path = os.path.join(self.test_project_dir, 'test_failure_script.py')
        with open(custom_script_path, 'w') as f:
            f.write('''
def remediate_test_vulnerability(context=None):
    """
...
''')
    ...
    def test_advanced_remediation_strategies(self):
        ...
        result = AdvancedRemediationStrategies.rollback_configuration(config_path, backup_path)
        self.assertTrue(result)
    ...
    def test_remediation_report_generation(self):
        ...
        mock_security_report = SecurityScanResult(
            ...
            high_vulnerabilities=[
                {'file': 'test.py', 'line': 10, 'description': 'Test high vulnerability'}
            ],
        ...
        report_files = [
            f for f in os.listdir(self.test_project_dir) 
