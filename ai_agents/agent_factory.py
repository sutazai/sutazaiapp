    ...
    def _discover_agents(self):
        ...
        for agent_type in os.listdir(self.agents_dir):
            ...
            try:
                ...
                logger.exception(f"❌ Failed to register agent {agent_type}: {e}")

    def create_agent(self, agent_type: str, config: Optional[Dict[str, Any]] = None) -> BaseAgent:
        """
        ...
        agent_instance = agent_class(agent_name=agent_name, log_dir=log_dir, **(config or {}))
