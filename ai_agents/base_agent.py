...
class BaseAgentImplementation:
    ...
    def _persist_performance_history(self, max_records: int = 100) -> None:
        ...
        """
        try:
            history_file = os.path.join(self.log_dir, f"{self.agent_name}_performance_history.json")
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        successful_tasks = sum(1 for record in self.performance_history if record.get("success", False))
