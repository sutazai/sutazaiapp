...
class DocumentProcessorAgent(BaseAgent):
    ...
    def _extract_text(self, document_path: str, pages: Optional[List[int]] = None) -> Dict[str, Any]:
        """
    ...
    def _ocr_processing(self, image_path: str, languages: List[str] = ["eng"]) -> Dict[str, Any]:
        """
    ...
    def _document_analysis(self, document_path: str, analysis_type: str = "structure") -> Dict[str, Any]:
        """
            ...
            for page_num, page in enumerate(doc):
                ...
                if "blocks" in text_dict:
                    ...
                    if analysis_results["text_blocks"]:
                        analysis_results["text_blocks"] = cast(List, analysis_results["text_blocks"]) + text_blocks
                    else:
                ...
                try:
                    ...
                    if analysis_results["images"]:
                        analysis_results["images"] = cast(List, analysis_results["images"]) + image_info
                    else:
                        analysis_results["images"] = image_info
                except Exception as img_ex:
                    logger.warning(f"Error processing images on page {page_num}: {img_ex}")
