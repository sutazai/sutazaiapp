...
def pytest_configure(config):    """
    ...
    Args:    config (pytest.Config): Pytest configuration object
    """
...
def pytest_addoption(parser):    """
    ...
    Args:    parser (pytest.Parser): Pytest argument parser
    """
...
def test_environment(request):    """
    ...
    Args:    request (pytest.FixtureRequest): Pytest fixture request

    Returns:    Dict: Test environment configuration
    """
...
def temp_document_dir(test_environment):    """
    ...
    Args:    test_environment (Dict): Test environment configuration

    Returns:    str: Path to temporary document directory
    """
import tempfile

with tempfile.TemporaryDirectory(
        prefix="sutazai_doc_test_", dir=test_environment["temp_dir"]
    ) as temp_dir:        yield temp_dir

    def pytest_terminal_summary(terminalreporter, exitstatus, config):    """
    Custom terminal summary for test results

    Args:    terminalreporter (TerminalReporter): Pytest terminal reporter
