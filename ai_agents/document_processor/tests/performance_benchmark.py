...
class DocumentProcessorBenchmark:
    ...
    def run_comprehensive_benchmark(num_docs: int = 10) -> Dict[str, Any]:
        ...
        # Run benchmarks
        benchmarks = {
            'text_extraction': DocumentProcessorBenchmark.benchmark_document_extraction(test_documents),
            'ocr_processing': DocumentProcessorBenchmark.benchmark_ocr_processing(test_documents),
            'document_analysis': DocumentProcessorBenchmark.benchmark_document_analysis(test_documents)
        }
...
def main():
    ...
    report_path = '/opt/sutazai_project/SutazAI/logs/document_processor_performance.json'
