...
@dataclass
class Message:    """Represents a message in the conversation with the model."""
...
role: str
    ...
    def to_dict(
        self) -> Dict:    """Convert message to dictionary format for API calls."""
    message = {"role": self.role, "content": self.content}
    if self.name:        message["name"] = self.name
    if self.function_call:    message["function_call"] = self.function_call
    return message

    class ModelError(Exception):        """Base class for model-related errors."""

    pass

    class ModelConfig:        """Configuration for model interactions."""
    ...
    def to_dict(
        self) -> Dict:    """Convert configuration to dictionary format for API calls."""
    return {
    ...
    class ModelManager:        """Manages interactions with language models."""
    ...
    Args:    role: Role of the message sender
    ...
    def clear_history(self) -> None:    """Clear the conversation history."""
    ...
    Args:    system_prompt: System prompt to prepend (
    optional)
    ...
    Args:    template: Prompt template string
    **kwargs: Variables to format into the template
    ...
    Args:    text: Text to count tokens in

    Returns:    int: Approximate number of tokens
