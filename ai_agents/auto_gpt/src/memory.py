...
class Message:
    ...
    def __post_init__(self):
        ...
        if self.timestamp is None:
            ...
            class Memory:
                                """Manages the agent's memory including conversation history and \
                    context."""
                                                ...
                                                if self.persist_path:
                                                    ...
                                                    def clear_context(
                                                        ...
                                                        if self.persist_path:
                                                            ...
                                                            def save(
                                                                self) -> None:
                                                                                                                                """Save memory state to disk if persist_path is \
                                                                    set."""
                                                                ...
                                                                def load(
                                                                    self) -> None:
                                                                                                                                        """Load memory state from disk if persist_path is \
                                                                        set."""
