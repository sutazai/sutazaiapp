...
class ModelConfig(BaseModel):    """Configuration for the language model used by AutoGPT."""
...
model_name: str = Field(
    ...
    class ToolConfig(BaseModel):        """Configuration for a tool that AutoGPT can use."""
    ...
    class AutoGPTConfig(BaseModel):        """Main configuration for AutoGPT agent."""
    ...
    class Config:        """Pydantic model configuration."""
    ...
    Args:    config: Dictionary or \
    AutoGPTConfig instance containing configuration

    Returns:    AutoGPTConfig: Validated configuration instance
    ...
    Returns:    AutoGPTConfig: Default configuration instance
    """
