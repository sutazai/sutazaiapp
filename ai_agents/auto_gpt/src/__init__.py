...
def __init__(
    ...
    Args:    config: Agent configuration
    ...
    Raises:    AgentError: If configuration is invalid
    """
    try:        validate_config(config)
    except Exception as e:    raise AgentError(f"Invalid configuration: {str(e)}")
    ...
    Args:    tool: Tool to register

    Raises:    AgentError: If tool registration fails
    """
    ...
    Args:    name: Name of the tool

    Returns:    Tool: The requested tool

    Raises:    AgentError: If tool is \
    not found
    """
    ...
    Returns:    List[Dict]: List of tool information dictionaries

    Raises:    AgentError: If tool listing fails
    """
    try:        return registry.list_tools()
    except Exception as e:    raise AgentError(
