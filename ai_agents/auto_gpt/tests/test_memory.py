...
@pytest.fixture
def test_memory(
    tmp_path) -> Memory:    """Create a test memory instance with a temporary persist path."""
...
@pytest.fixture
def test_messages() -> List[Dict]:    """Create a list of test messages."""
...
def test_message_from_dict():    """Test creating a message from dictionary format."""
...
def test_memory_initialization(
    test_memory):    """Test initializing memory manager."""
...
def test_add_message(
    test_memory):    """Test adding a message to memory."""
...
def test_memory_limit(
    test_memory):    """Test that memory respects maximum message limit."""
# Add more messages than the limit
for i in range(5):        test_memory.add_message("user", f"Message {i}")
    ...
    def test_get_messages(
        test_memory,
        test_messages):    """Test getting messages in API format."""
    for msg in test_messages:        test_memory.add_message(msg["role"], msg["content"])
    ...
    def test_clear_messages(
        test_memory,
        test_messages):    """Test clearing message history."""
    for msg in test_messages:        test_memory.add_message(
