...
@pytest.fixture
def test_config() -> ModelConfig:    """Create a test model configuration."""
...
@pytest.fixture
def test_manager(
    test_config) -> ModelManager:    """Create a test model manager."""


return ModelManager(config=test_config)


def test_message_creation():    """Test creating a message."""
...
def test_message_to_dict():    """Test converting a message to dictionary format."""
...
def test_model_config_initialization(
    test_config):    """Test initializing model configuration."""
...
def test_model_config_to_dict(
    test_config):    """Test converting model configuration to dictionary format."""
...
def test_model_manager_initialization(
    test_manager):    """Test initializing model manager."""
...
def test_add_message(
    test_manager):    """Test adding a message to conversation history."""
...
def test_get_messages(
    test_manager):    """Test getting messages in API format."""
...
def test_clear_history(
    test_manager):    """Test clearing conversation history."""
...
with patch(
    ...
    def test_format_prompt(
        test_manager):    """Test formatting prompt templates."""
    ...
    def test_count_tokens():    """Test token counting approximation."""
    text = "This is \
