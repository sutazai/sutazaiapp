# CHANGELOG - sample_project

- **Location**: `/opt/sutazaiapp/mcp-servers/claude-task-runner/sample_project`
- **Purpose**: Directory for sample_project related files and resources
