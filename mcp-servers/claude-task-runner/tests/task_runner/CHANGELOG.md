# CHANGELOG - task_runner

- **Location**: `/opt/sutazaiapp/mcp-servers/claude-task-runner/tests/task_runner`
- **Purpose**: Test files and test utilities - task_runner subdirectory
