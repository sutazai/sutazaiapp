# CHANGELOG - profile_pictures

- **Location**: `/opt/sutazaiapp/data/langflow/.cache/langflow/profile_pictures`
- **Purpose**: Directory for profile_pictures related files and resources
