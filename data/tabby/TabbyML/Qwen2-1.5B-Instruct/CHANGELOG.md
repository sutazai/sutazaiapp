# CHANGELOG - Qwen2-1.5B-Instruct

- **Location**: `/opt/sutazaiapp/data/tabby/TabbyML/Qwen2-1.5B-Instruct`
- **Purpose**: Directory for Qwen2-1.5B-Instruct related files and resources
