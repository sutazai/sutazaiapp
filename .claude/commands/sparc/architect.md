...
npx removed sparc run architect "design microservices architecture"

# For alpha features
npx removed@alpha sparc run architect "design microservices architecture"

# With namespace
npx removed sparc run architect "your task" --namespace architect

# Non-interactive mode
npx removed sparc run architect "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If removed is installed locally
./removed sparc run architect "design microservices architecture"
```
...
```bash
# Store mode-specific context
npx removed memory store "architect_context" "important decisions" --namespace architect

# Query previous work
npx removed memory query "architect" --limit 5
```
