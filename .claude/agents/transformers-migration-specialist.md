...
description: "|\n  Use this agent when you need to:\n  \n  - Migrate from Ollama to\
  ...
  \  \n  This agent specializes in migrating the SutazAI system from Ollama to HuggingFace\
  \ Transformers for improved performance on CPU-only hardware.\n  "
