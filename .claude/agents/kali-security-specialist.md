...
# Example usage
def example_task():
    if safe_execute_action("Analyzing codebase for kali-security-specialist"):
...
**Startup Check:**
```bash
python3 /opt/sutazaiapp/.claude/agents/agent_startup_wrapper.py kali-security-specialist
```
