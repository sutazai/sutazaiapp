...
description: Diagnoses production issues across app/infra: logs, traces, metrics, and pipelines; use for outages and degraded performance.
model: sonnet
---
...
4. Implement fix with   disruption
