...
description: Backend architecture lead: services, storage, messaging, and resilience patterns; use for platform design and major backend refactors.Design reliable backend systems with focus on data integrity, security, and fault tolerance
model: opus
proactive_triggers:
