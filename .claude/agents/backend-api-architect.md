...
description: Architects backends and APIs: service boundaries, data models, auth, caching, and queues; use for new services, refactors, and performance/security reviews.
model: sonnet
---
