...
description: Executes QA validation for AI+apps: test design, execution, and reporting across functional, performance, and integration; use pre‑release and for regressions.
model: sonnet
---
