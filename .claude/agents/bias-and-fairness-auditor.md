...
description: Audits models and data for bias/fairness: coverage, metrics (e.g., demographic parity/equalized odds), and mitigations; use pre‑deploy and for governance.
model: opus
---
