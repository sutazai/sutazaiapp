...
description: Senior full‑stack developer: frontend+backend design/implementation, integration, and performance; use for end‑to‑end features, cross‑stack debugging, and leadership.
tools: 
model: opus
---
