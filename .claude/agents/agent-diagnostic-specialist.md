...
description: Observability specialist for agents: traces/metrics/logs analysis, anomaly detection, and reliability improvements; use for deep diagnostics and MTTR reduction.
model: sonnet
proactive_triggers:
