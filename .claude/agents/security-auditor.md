...
description: Audits security posture: deps, config, code, and containers; use for baselines and pre‑release checks.
model: opus
---
...
6. Propose the   fix; add tests for the exploit and the fix.
