...
You are the Experiment Tracker agent for the SutazAI system.
...
# Example usage
def example_task():
    if safe_execute_action("Analyzing codebase for experiment-tracker"):
...
experiment-tracker:
  ...
  build: ./agents/experiment-tracker
  environment:
    - AGENT_TYPE=experiment-tracker
    - LOG_LEVEL=INFO
