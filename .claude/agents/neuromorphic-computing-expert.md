...
# Example usage
def example_task():
    if safe_execute_action("Analyzing codebase for neuromorphic-computing-expert"):
...
```python
class Neuromorphic_Computing_ExpertAgent:
    """
...
neuromorphic-computing-expert:
  container_name: sutazai-neuromorphic-computing-expert
  build: ./agents/neuromorphic-computing-expert
  environment:
    - AGENT_TYPE=neuromorphic-computing-expert
    - LOG_LEVEL=INFO
