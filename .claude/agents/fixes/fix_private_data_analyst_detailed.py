#!/usr/bin/env python3
"""
Compliance Fix for private-data-analyst-detailed
...
def fix_private_data_analyst_detailed():
    """Fix compliance issues for private-data-analyst-detailed"""
    
    agent_file = Path('/opt/sutazaiapp/.claude/agents/private-data-analyst-detailed.md')
...
def example_agent_action():
    action_desc = "Analyzing codebase for private-data-analyst-detailed tasks"
...
- `AGENT_NAME=private-data-analyst-detailed` - This agent's name for logging
...
'''
    ...
    if modified:
        with open(agent_file, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"✅ Fixed private-data-analyst-detailed")
        return True
    else:
        print(f"ℹ️  private-data-analyst-detailed already compliant")
        return True

if __name__ == "__main__":
    success = fix_private_data_analyst_detailed()
