#!/usr/bin/env python3
"""
Compliance Fix for resource-visualiser-detailed
...
def fix_resource_visualiser_detailed():
    """Fix compliance issues for resource-visualiser-detailed"""
    
    agent_file = Path('/opt/sutazaiapp/.claude/agents/resource-visualiser-detailed.md')
...
def example_agent_action():
    action_desc = "Analyzing codebase for resource-visualiser-detailed tasks"
...
- `AGENT_NAME=resource-visualiser-detailed` - This agent's name for logging
...
'''
    ...
    if modified:
        with open(agent_file, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"✅ Fixed resource-visualiser-detailed")
        return True
    else:
        print(f"ℹ️  resource-visualiser-detailed already compliant")
        return True

if __name__ == "__main__":
    success = fix_resource_visualiser_detailed()
