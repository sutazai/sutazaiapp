#!/usr/bin/env python3
"""
Compliance Fix for knowledge-graph-builder-detailed
...
def fix_knowledge_graph_builder_detailed():
    """Fix compliance issues for knowledge-graph-builder-detailed"""
    
    agent_file = Path('/opt/sutazaiapp/.claude/agents/knowledge-graph-builder-detailed.md')
...
def example_agent_action():
    action_desc = "Analyzing codebase for knowledge-graph-builder-detailed tasks"
...
- `AGENT_NAME=knowledge-graph-builder-detailed` - This agent's name for logging
...
'''
    ...
    if modified:
        with open(agent_file, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"✅ Fixed knowledge-graph-builder-detailed")
        return True
    else:
        print(f"ℹ️  knowledge-graph-builder-detailed already compliant")
        return True

if __name__ == "__main__":
    success = fix_knowledge_graph_builder_detailed()
