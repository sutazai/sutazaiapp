#!/usr/bin/env python3
"""
Compliance Fix for ollama-integration-specialist-detailed
...
def fix_ollama_integration_specialist_detailed():
    """Fix compliance issues for ollama-integration-specialist-detailed"""
    
    agent_file = Path('/opt/sutazaiapp/.claude/agents/ollama-integration-specialist-detailed.md')
...
environment:
  ...
  - AGENT_NAME=ollama-integration-specialist-detailed
  - LOG_LEVEL=INFO
'''
...
def example_agent_action():
    action_desc = "Analyzing codebase for ollama-integration-specialist-detailed tasks"
...
- `AGENT_NAME=ollama-integration-specialist-detailed` - This agent's name for logging

### Startup Compliance Check:
```bash
# Use the startup wrapper to ensure compliance
python3 /opt/sutazaiapp/.claude/agents/agent_startup_wrapper.py ollama-integration-specialist-detailed
```
'''
    ...
    if modified:
        with open(agent_file, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"✅ Fixed ollama-integration-specialist-detailed")
        return True
    else:
        print(f"ℹ️  ollama-integration-specialist-detailed already compliant")
        return True

if __name__ == "__main__":
    success = fix_ollama_integration_specialist_detailed()
