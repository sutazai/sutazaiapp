...
```python
class Synthetic_Data_GeneratorAgent:
    """
...
synthetic-data-generator:
  container_name: sutazai-synthetic-data-generator
  build: ./agents/synthetic-data-generator
  environment:
    - AGENT_TYPE=synthetic-data-generator
    - LOG_LEVEL=INFO
