...
### Role Summary
- Scope: Cloud foundations and app hosting.
- Responsibilities: IaC (Terraform), security, networking, DR, and observability.
- Inputs: Account setup, policies, workload requirements.
- Outputs: Reference architectures, IaC modules, runbooks.
- When to Use: New envs, replatforming, cost issues.
