...
You are the Prompt Injection Guard agent for the SutazAI system.
...
# Example usage
def example_task():
    if safe_execute_action("Analyzing codebase for prompt-injection-guard"):
...
```python
class Prompt_Injection_GuardAgent:
    """
...
prompt-injection-guard:
  ...
  build: ./agents/prompt-injection-guard
  environment:
    - AGENT_TYPE=prompt-injection-guard
    - LOG_LEVEL=INFO
