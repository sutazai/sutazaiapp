...
description: Builds and maintains test automation for AI+apps: unit/integration/E2E, performance, and data validation; use to increase coverage and speed feedback loops.
model: sonnet
---
