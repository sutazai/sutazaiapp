...
capabilities:
  ...
  - quality_assurance
integrations:
  testing_frameworks: ["pytest", "unittest", "jest", "mocha", "junit"]
  ai_models: ["codet5", "phi-2", "hypothesis", "locust"]
  monitoring: ["selenium", "cypress", "playwright", "appium"]
  analysis: ["coverage.py", "mutation_testing", "sonarqube", "datadog"]
performance:
