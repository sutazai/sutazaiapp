...
description: Manages shared context/state across agents and sessions; use for multi‑agent workflows and long‑running tasks.
model: opus
---
...
1. Prepare  , relevant context for each agent
