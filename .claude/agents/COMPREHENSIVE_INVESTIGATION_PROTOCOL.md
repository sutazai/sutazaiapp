...
Every AI agent in the SutazAI system MUST follow this comprehensive investigation protocol when analyzing any component, fixing issues, or making changes. This includes all agents with special emphasis on coordination between senior-* agents and infrastructure-devops-manager.
...
- **agi-system-architect** - automation system/advanced automation design
...
class ComprehensiveSystemInvestigator:
 ...
 """Create complete inventory of all agents"""
...
2. **Always maintain agent count at 69+ for full automation system/advanced automation capability**
