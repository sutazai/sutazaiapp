...
description: Produces explainability/transparency artifacts: prediction explanations, reports, and documentation; use for compliance and stakeholder clarity.
model: sonnet
---
