...
class SystemDiagnostic:
    ...
    def collect_system_info(self):
        ...
        try:
            ...
            self.diagnostic_report['potential_issues'].append(f"System info collection failed: {e}")
    ...
    def analyze_performance(self):
        ...
        try:
            ...
            self.diagnostic_report['potential_issues'].append(f"Performance analysis failed: {e}")
    ...
    def check_network(self):
        ...
        try:
            ...
            self.diagnostic_report['potential_issues'].append(f"Network diagnostics failed: {e}")

    def generate_report(self, output_path='/var/log/sutazai/system_diagnostic_report.json'):
