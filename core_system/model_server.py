...
ACTIVE_CONNECTIONS = Gauge('active_connections', 'Current active model server connections')
...
async def health_check():
    ...
    return {
        ...
        "memory_usage": {
            ...
            "current": model_server.model.get_memory_footprint() if model_server.model else 0
        },
        "metrics": {
