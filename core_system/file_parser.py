...
class RobustFileParser:
        ...
        for encoding in self.encodings:
            try:
                with open(file_path, 'r', encoding=encoding) as f:
                    ...
                    self.parsing_report['encoding_attempts'].setdefault(file_path, []).append(encoding)
                    ...
                    try:
                        ...
                        self.logger.info(f"Successfully parsed {file_path} with {encoding} encoding")
                        break
    ...
    def _generate_report(self):
        ...
        if self.parsing_report['failed_files']:
            ...
            for failed_file in self.parsing_report['failed_files'][:10]:  # Limit to first 10
                print(f"  - {failed_file}")
