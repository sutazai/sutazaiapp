...
class AdvancedLogger:
    ...
    def _configure_logger(self, log_level: int) -> logging.Logger:
        ...
        system_log_path = os.path.join(self.base_dir, "logs", "system", "system.log")
...
def setup_secure_logging(
    ...
    # Optional file logging with secure permissions
    if log_dir:
        os.makedirs(log_dir, exist_ok=True)
        log_file = os.path.join(log_dir, 'sutazai.log')
...
logger = setup_secure_logging(log_dir='/var/log/sutazai')


def setup_logging_directory(dir_path: str) -> None:
    """Set up logging directory with secure permissions."""
    try:
        os.makedirs(dir_path, exist_ok=True)
        # Set permissions to user read/write, group read, others none (0o640)
