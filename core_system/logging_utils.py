...
class AdvancedLogger:
    ...
    def __init__(
        ...
        self.config_path = config_path or os.path.join(base_dir, 'config', 'logging_config.yaml')
    ...
    def _create_log_directories(self):
        ...
        log_subdirs = [
            'system', 'workers', 'error_correction', 
            'performance', 'security', 'distributed_tracing'
        ]
