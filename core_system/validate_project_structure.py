...
class ProjectStructureValidator:
    ...
    def __init__(
        ...
        self.config_path = config_path or os.path.join(base_dir, 'config', 'project_structure_config.yml')
    ...
    def validate_project_structure(self) -> Dict[str, Any]:
        ...
        validation_report['optimization_recommendations'] = self._generate_optimization_recommendations(
            validation_report
        )
    ...
    def _validate_directories(self) -> Dict[str, Any]:
        ...
        for directory in self.config.get('required_directories', []):
            ...
            directory_validation['required_directories'][directory] = os.path.exists(full_path)
        ...
        extra_dirs = set(all_directories) - set(self.config.get('required_directories', []))
    ...
    def _log_validation_report(self, validation_report: Dict[str, Any]):
        ...
        self.logger.info(f"Missing Directories: {validation_report['directory_structure']['missing_directories']}")
        self.logger.info(f"Non-Compliant Files: {sum(len(files['non_compliant']) for files in validation_report['naming_compliance'].values())}")
        self.logger.info(f"Security Issues: {len(validation_report['security_checks']['hardcoded_credentials'])}")
...
def main():
    ...
    print("\nDirectory Structure:")
    print(f"Missing Directories: {validation_report['directory_structure']['missing_directories']}")
    print(f"Extra Directories: {validation_report['directory_structure']['extra_directories']}")
    ...
    print("\nSecurity Checks:")
    print(f"Hardcoded Credentials: {len(validation_report['security_checks']['hardcoded_credentials'])}")
