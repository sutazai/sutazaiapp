...
class TestArchitecturalIntegrityManager(unittest.TestCase):
    ...
    def test_perform_architectural_integrity_analysis(self):
        ...
        """
        architectural_report = self.architectural_manager.perform_architectural_integrity_analysis()
    ...
    def test_code_quality_metrics(self):
        ...
        for module, complexity in code_quality_metrics['complexity_distribution'].items():
    ...
    def test_architectural_patterns(self):
        ...
        expected_categories = ['core_system', 'workers', 'services', 'utils', 'external']
    ...
    def test_cross_reference_map(self):
        ...
        for module, relationships in cross_reference_map['inheritance_relationships'].items():
    ...
    def test_architectural_report_persistence(self):
        ...
        log_files = [
            f for f in os.listdir(self.architectural_manager.log_dir) 
