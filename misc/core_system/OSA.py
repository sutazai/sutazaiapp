...
if _impl == "cpp":
    ...
    if supports(AVX2):
        with contextlib.suppress(ImportError):
            from rapidfuzz.distance.metrics_cpp_avx2 import (
                osa_distance as distance,  # pyright: ignore[reportMissingImports]
            )
            from rapidfuzz.distance.metrics_cpp_avx2 import (
    ...
    from rapidfuzz.distance.metrics_py import osa_distance as distance
    ...
    from rapidfuzz.distance.metrics_py import osa_similarity as similarity
else:
    imported = False
    if supports(AVX2):
        with contextlib.suppress(ImportError):
