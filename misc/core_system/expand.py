        ...
        try:
            ...
            if package_dir and module_name in package_dir:
                module_path = os.path.join(
                    str(root_dir), package_dir[module_name]
                )
                module_path = os.path.join(module_path, "__init__.py")
            else:
                module_path = os.path.join(
                    str(root_dir), module_name.replace(".", os.sep) + ".py"
                )
            ...
            if not os.path.exists(module_path) and not module_path.endswith(
                ".py"
            ):
                module_path += ".py"
...
def version(
    value: Union[Callable[[], Any], Iterable[Union[str, int]], str],
) -> str:
    """
