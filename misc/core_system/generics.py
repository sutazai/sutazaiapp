...
if sys.version_info >= (     3, 11):  # Typing for weak dictionaries available at 3.9
...
def replace_types(type_: Any, type_map: Mapping[Any, Any]) -> Any:
    ...
    if (origin_type is ExtLiteral) or (
        sys.version_info >= (     3, 11) and origin_type is Literal
    ):
    ...
    if type_args:
        ...
        if (
            sys.version_info >= (     3, 11) and origin_type is types.UnionType
        ):  # noqa: E721
