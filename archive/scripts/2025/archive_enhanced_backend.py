...
async def get_agents():
    ...
    base_agents = [
        {"id": "tinyllama", "name": "DeepSeek-R1", "type": "coding", "status": "active", "capabilities": ["code_generation", "reasoning"]},
...
async def chat_with_agent(agent_id: str, chat_data: ChatRequest):
    ...
    responses = {
        "tinyllama": f"DeepSeek-R1 here! I've analyzed your message: '{message}'. I can help with advanced coding tasks, reasoning, and problem-solving.",
...
async def get_models():
    ...
    base_models = [
        {"id": "tinyllama", "name": "DeepSeek-R1 8B", "status": "loaded", "type": "reasoning"},
