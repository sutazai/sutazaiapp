#!/bin/bash
# ARCHIVED COPY — moved from scripts/service-mesh-init.sh
...
# This script is retained for reference and may not be compatible with the
# current docker-compose footprint.
echo "[DEPRECATED] Service mesh initialization is deprecated. Use Redis-based mesh instead."
echo "            See docs/mesh/lightweight-mesh.md and docs/decisions/2025-08-07-remove-service-mesh.md"
