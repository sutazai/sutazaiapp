...
def render_chat_interface():
    ...
    models = ["deepseek-coder:33b", "mistral:7b", "llama3.2:3b", "deepseek-r1:8b"]
...
def render_agent_management():
    ...
    agents = [
        ...
        {"name": "Researcher", "type": "Research", "status": "active", "model": "deepseek-r1:8b"},
    ]
    ...
    with st.expander("Create a New Agent"):
        with st.form("new_agent_form", clear_on_submit=True):
            ...
            model = st.selectbox("Underlying Model", ["deepseek-coder:33b", "mistral:7b", "llama3.2:3b", "deepseek-r1:8b"])
