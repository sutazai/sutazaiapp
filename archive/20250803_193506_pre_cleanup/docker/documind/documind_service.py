...
import aiofiles
import specific implementation name (e.g., emailSender, dataProcessor)
...
async def process_document(file: UploadFile = File(...)):
    ...
    try:
        # Detect file type
        file_type = specific implementation name (e.g., emailSender, dataProcessor).from_file(temp_file_path, mime=True)
