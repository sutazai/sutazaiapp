...
def show_sidebar():
    ...
    model = st.sidebar.selectbox(
        "Primary Model",
        ["deepseek-r1:8b", "qwen2.5:3b", "codellama:7b", "llama2:7b"],
...
def show_monitoring():
    ...
    if health_data and "services" in health_data:
        ...
        categories = {
            "Core": ["ollama", "chromadb", "qdrant", "backend", "litellm"],
...
def show_settings():
    ...
    with tab1:
        ...
        litellm_url = st.text_input("LiteLLM Proxy URL", value=LITELLM_URL)
    ...
    with tab2:
        ...
        # Model mappings
        st.markdown("#### LiteLLM Model Mappings")
