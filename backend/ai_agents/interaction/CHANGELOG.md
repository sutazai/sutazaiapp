...
All notable changes to the Agent Interaction Layer module will be documented in this file.
...
### Added
- Initial agent interaction layer implementation
- Agent-user interaction layer
