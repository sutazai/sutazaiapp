...
class DocumentParser:
    ...
    def __init__(self, output_dir: str = "/opt/sutazaiapp/doc_data/parsed", max_file_size_mb: int = 50):
        """
    ...
    def parse_pdf(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Save parsed content
            output_file = os.path.join(self.output_dir, f"{os.path.basename(file_path)}_parsed.json")

            result = {"filename": os.path.basename(file_path), "total_pages": len(doc), "pages": pages}
