...
def mock_external_services():
    ...
    with patch('backend.app.main.check_ollama', new_callable=AsyncMock) as mock_ollama, \
        ...
        mock_models.return_value = ["llama3.2:1b", "qwen2.5:3b", "codellama:7b"]
...
class TestThinkingEndpoints:
    ...
    def test_agi_think_endpoint(self, client_with_mocks):
        """Test AGI thinking endpoint with authentication"""
        request_data = {
