...
All notable changes to the Edge Inference Service module will be documented in this file.
...
### Added
- Initial edge inference service implementation
- Edge device inference capabilities
