...
class OTPManager:
    def __init__(
        self,
        root_email="chrissuta01@gmail.com",
        ...
        logging.basicConfig(
        filename="/opt/sutazaiapp/logs/otp_manager.log",
        level=logging.INFO,
        ...
        def _generate_encryption_key(self):
            ...
            # Define key path in the /opt/sutazaiapp/config directory
            key_path = "/opt/sutazaiapp/config/otp_encryption.key"
        ...
        def validate_otp(self, user_otp, stored_otp_info):
            ...
            try:
                ...
                def send_otp_email(self, otp):
                    ...
                    try:
                        msg = MIMEText(
                            f"Your SutazAI Network Access OTP is: {otp}")
                        ...
                        logging.info(f"OTP email sent to {self.root_email}")
                            ...
                            def main():
                                ...
                                validation_result = otp_manager.validate_otp(
                                    decrypted_otp,
                                    otp_info)

                                print(
                                    f"OTP Validation Result: {validation_result}")
