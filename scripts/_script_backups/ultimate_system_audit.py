...
It then consolidates these metrics into a summary report and \
    prints the results.
"""
        ...
        def network_diagnostics(self) -> Dict[str, Any]:
            ...
            for name, details in interfaces.items()
                ...
                "default_gateway": self._get_default_gateway(),
                    ...
                    logger.exception("Network diagnostics error: {e}")
                        ...
                        if platform.system() == "Windows":
                            ...
                            def generate_comprehensive_report(self) -> str:
                                ...
                                try:
                                    ...
                                    logger.info(
                                        "System audit report generated: %s",
                                        report_path)
                                return report_path

                                except Exception:
                                    logger.exception(
                                        "System audit failed: {e}")
                                    sys.exit(1)
                                    ...
                                    "total": psutil.disk_usage(
                                        partition.mountpoint).total
                                    / (1024**3),  # GB
                                    "used": psutil.disk_usage(
                                        partition.mountpoint).used / (1024**3),  # GB
                                    "free": psutil.disk_usage(
                                        partition.mountpoint).free / (1024**3),  # GB
                                    ...
                                    for partition in psutil.disk_partitions()
                                        ...
                                        def get_system_message() -> str:
                                            ...
                                            if cpu_usage is None:
                                                                                        return "CPU usage data is \
                                                unavailable."
                                            else:
                                                                                return f"System is \
                                            running with CPU usage at {cpu_usage}%."
                                        ...
                                        def get_cpu_usage() -> Dict[str, float]:
                                            ...
                                            per_cpu_usage = psutil.cpu_percent(
                                                ...
                                                percpu=True)
                                            avg_usage = sum(
                                                per_cpu_usage) / len(per_cpu_usage) if per_cpu_usage else 0.0
                                        ...
                                        def get_memory_usage() -> Dict[str, float]:
                                            ...
                                            Returns:
                                            Dict[str, float]: Dictionary containing total, available, and used memory (
                                                in bytes)
                                        ...
                                        def get_disk_usage() -> Dict[str, Dict[str, float]]:
                                            ...
                                            total, used, free space (
                                                in bytes), and the disk usage percentage.
                                            """
