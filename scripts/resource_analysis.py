...
class ResourceAnalyzer:
    ...
    def calculate_minimum_requirements(self):
        """Calculate minimum requirements for core AGI functionality"""
        core_services = [
            'postgres', 'redis', 'neo4j', 'ollama', 'backend-agi', 'frontend-agi',
        ...
        if any(b['type'] == 'Memory' for b in bottlenecks):
            recommendations.extend([
                ...
                },
                {
                    ...
                    'details': 'Run only essential services: postgres, redis, ollama, backend-agi, frontend-agi',
    ...
    def generate_report(self):
        ...
        print("\n💡 MINIMUM REQUIREMENTS FOR CORE AGI")
        print("-" * 40)
