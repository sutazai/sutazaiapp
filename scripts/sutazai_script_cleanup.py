...
{}
return details
except Exception as e:                                logger.error(                        f"Error extracting details from {script_path}: {e}",                        )                        return {}                    def consolidate_scripts(                                    self,                                ) -> Self()                                consolidated_details = {}                        for category, scripts in categories.items():                                    logger.info()
...
def remove_minimal_scripts(self) -> Self,                                                        script,                                    )
...
def cleanup_shell_scripts(self) -> Self,                                                                            script,                                                                        )                                                # Check
                                    # file
                                    # size
