                ...
                if file.is_file():
                    ...
                    stat = file.stat()
                        ...
                        """Perform database maintenance and optimization."""
                            ...
                            logger.info(f"Database optimization completed successfully")
                            except Exception:
                            ...
                            """Clear Redis cache if memory usage is high."""
                                ...
                                used_memory = info["used_memory"] / 1024 / 1024  # Convert to MB
                                    ...
                                    logger.info(f"Cleared Redis cache due to high memory usage")
                                        else:
                                        ...
                                        maintenance = SystemMaintenance()
                                            ...
                                            await asyncio.sleep(int(os.getenv("MAINTENANCE_INTERVAL", 3600)))
                                                ...
                                                if __name__ == "__main__":
                                                    ...
                                                    logger.info(f"Maintenance script stopped by user")
                                                    sys.exit(0)
