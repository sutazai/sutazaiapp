                            ...
                            def main():
                                ...
                                def example_function():
                                    ...
                                    [f for f in os.listdir(
                                        profiler.output_dir) if f.endswith(".prof")],
                                    key=lambda x: os.path.getctime(
                                        os.path.join(profiler.output_dir, x)),
                                    )
                                    profiler.analyze_profile(
                                        os.path.join(profiler.output_dir, latest_profile))
