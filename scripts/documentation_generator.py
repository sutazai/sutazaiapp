...
class DocumentationGenerator:
    ...
    def generate_module_documentation(
        ...
        try:
            ...
            module_doc["docstring"] = (
                ast.get_docstring(tree) or "No module-level documentation"
            )
    ...
    def generate_markdown_documentation(
        ...
        markdown_doc += (
            "SutazAI is an advanced, autonomous AI development platform.\n\n"
        )
