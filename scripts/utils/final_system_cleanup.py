...
FANTASY_TERMS = {
    ...
    r'backend': 'backend',
    r'frontend': 'frontend',
    r'sutazai-backend': 'sutazai-backend',
    r'sutazai-frontend': 'sutazai-frontend',
}
...
class SystemCleaner:
    ...
    def find_remaining_fantasy_terms(self) -> Set[str]:
        ...
        remaining = set()
        fantasy_patterns = ['automation', 'advanced automation', 'processing', 'system_state', 'coordinator', 'advanced']
