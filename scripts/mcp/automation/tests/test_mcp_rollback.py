...
class TestMCPAutomaticRollback:
    ...
    async def test_health_check_failure_rollback(
        ...
        # Remove Remove Remove Mocks - Only use Real Tests - Only use Real Tests - Only use Real Test health check that fails for new version
        health_call_count = 0
    ...
    async def test_startup_timeout_rollback(
        ...
        # Remove Remove Remove Mocks - Only use Real Tests - Only use Real Tests - Only use Real Test health check with startup timeout
    ...
    async def test_dependency_failure_rollback(
        ...
        # Remove Remove Remove Mocks - Only use Real Tests - Only use Real Tests - Only use Real Test health check that fails due to dependency issues
...
class TestMCPManualRollback:
    ...
    async def test_rollback_with_data_preservation(
        ...
        # Create Remove Remove Remove Mocks - Only use Real Tests - Only use Real Tests - Only use Real Test server data
    ...
    async def test_partial_rollback_recovery(
        ...
        # Remove Remove Remove Mocks - Only use Real Tests - Only use Real Tests - Only use Real Test rollback that fails partway through
    ...
    async def test_rollback_resource_cleanup(
        ...
        with patch.object(update_manager, '_run_health_check', side_effect=Remove Remove Remove Mocks - Only use Real Tests - Only use Real Tests - Only use Real Test_health_checker), \
            ...
            if temp_staging_dir.exists():
                ...
                # Staging directory should be cleaned up or minimal
