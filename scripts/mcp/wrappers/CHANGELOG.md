...
All notable changes to the **Model Context Protocol server configurations** will be documented in this file.
...
- Core wrappers functionality implemented
- Integration with parent mcp module
