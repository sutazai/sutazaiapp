            ...
            def _check_pip_version(self) -> Dict[str, Any]:
                ...
                def _check_virtual_environment(self) -> Dict[str, Any]:
                    ...
                    "status": "OK" if venv_path else "WARNING",
                        ...
                        logger.exception(
                            f"Virtual environment check failed: {e}")
                    return {"error": str(e), "status": "ERROR"}
                        ...
                        try:
                            ...
                            for package, version_req in required_packages.items():
                                ...
                                def generate_health_report(self) -> str:
                                    ...
                                    report_filename = f'health_report_{datetime.now(
                                ...
                                def main():
                                    ...
                                    try:
                                        ...
                                        print(
                                            f"Health report generated: {report_path}")
                                        ...
                                        if any(
                                            dep.get("status") == "ERROR" for dep in report["dependencies"].values()):
                                            sys.exit(1)
