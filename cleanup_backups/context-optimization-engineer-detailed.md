...
#!/usr/bin/env python3
"""
Context Optimization Engineer - Comprehensive AGI Agent Implementation
...
This comprehensive implementation ensures the context-optimization-engineer agent operates efficiently within the SutazAI advanced AI system while maintaining the conservative resource strategy.