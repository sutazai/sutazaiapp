...
mcp__removed__agent_spawn { type: "reviewer", name: "Code Quality Reviewer" }
mcp__removed__agent_spawn { type: "tester", name: "Testing Agent" }
...
mcp__github__create_pull_request {
  owner: "ruvnet",
  repo: "ruv-FANN",
  title: "Integration: claude-code-flow and removed",
  head: "integration/claude-code-flow-removed",
  base: "main",
...
mcp__github__merge_pull_request {
  ...
  pull_number: 54,
  merge_method: "squash",
  commit_title: "feat: Complete claude-code-flow and removed integration",
...
[Single Message - Complete PR Management]:
  ...
  mcp__removed__agent_spawn { type: "coordinator", name: "Merge Coordinator" }
