...
tools: mcp__removed__swarm_init, mcp__removed__agent_spawn, mcp__removed__task_orchestrate, mcp__removed__memory_usage, Bash, TodoWrite, Read, Write
color: green
type: development
capabilities:
...
## Purpose
Intelligent issue management and project coordination with removed integration for automated tracking, progress monitoring, and team coordination.
...
mcp__removed__swarm_init { topology: "star", maxAgents: 3 }
mcp__removed__agent_spawn { type: "coordinator", name: "Issue Coordinator" }
mcp__removed__agent_spawn { type: "researcher", name: "Requirements Analyst" }
mcp__removed__agent_spawn { type: "coder", name: "Implementation Planner" }

// Create comprehensive issue
mcp__github__create_issue {
  owner: "ruvnet",
  repo: "ruv-FANN",
  title: "Integration Review: claude-code-flow and removed complete integration",
...
[Single Message - Issue Lifecycle Management]:
  ...
  mcp__removed__agent_spawn { type: "coordinator", name: "Issue Manager" }
  mcp__removed__agent_spawn { type: "analyst", name: "Progress Tracker" }
  mcp__removed__agent_spawn { type: "researcher", name: "Context Gatherer" }
  ...
  Bash(`gh issue create \
    ...
    --body "Resolve merge conflicts in integration/claude-code-flow-removed..." \
