...
npx removed benchmark-run --suite comprehensive --duration 300

# Execute specific benchmark
npx removed benchmark-run --suite throughput --iterations 10

# Compare with baseline
npx removed benchmark-compare --current <results> --baseline <baseline>

# Quality assessment
npx removed quality-assess --target swarm-performance --criteria throughput,latency

# Performance validation
npx removed validate-performance --results <file> --criteria <file>
```

### Regression Detection Commands
```bash
# Detect performance regressions
npx removed detect-regression --current <results> --historical <data>

# Set up automated regression monitoring
npx removed regression-monitor --enable --sensitivity 0.95

# Analyze error patterns
npx removed error-analysis --logs <log-files>
```
