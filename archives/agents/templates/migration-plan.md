...
tools:
  allowed:
    ...
    - mcp__removed__topology_optimize
...
tools:
  allowed:
    ...
    - mcp__removed__daa_agent_create
    - mcp__removed__agent_list
    - mcp__removed__memory_usage
  restricted:
    - Bash
    - Write
...
tools:
  allowed:
    ...
    - mcp__removed__task_status
    - mcp__removed__task_results
...
tools:
  allowed:
    ...
    - mcp__removed__swarm_init
    - mcp__removed__agent_spawn
    - mcp__removed__github_code_review
    - mcp__removed__memory_usage
  restricted:
    - Write
    - Edit
...
tools:
  allowed:
    - Bash
    - Read
    - mcp__removed__github_release_coord
    - mcp__removed__swarm_init
    - mcp__removed__task_orchestrate
    - TodoWrite
  restricted:
...
tools:
  allowed:
    ...
    - TodoWrite
  restricted:
    - mcp__removed__swarm_init  # Focus on implementation
triggers:
...
tools:
  allowed:
    ...
    - mcp__removed__metrics_collect
    - mcp__removed__trend_analysis
    - Read
    - Grep
  restricted:
    - Write
...
tools:
  allowed:
    - mcp__removed__token_usage
    - mcp__removed__cost_analysis
    - mcp__removed__usage_stats
    - mcp__removed__memory_analytics
    - Read
  restricted:
    - Write
    - Edit
...
tools:
  allowed:
    ...
    - mcp__removed__memory_namespace
    - mcp__removed__memory_compress
    - mcp__removed__memory_sync
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    - mcp__removed__neural_train
    - mcp__removed__neural_patterns
    - mcp__removed__neural_predict
    - mcp__removed__cognitive_analyze
    - mcp__removed__learning_adapt
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    - mcp__removed__daa_agent_create
    - mcp__removed__daa_capability_match
    - mcp__removed__daa_resource_alloc
    - mcp__removed__swarm_scale
    - mcp__removed__agent_metrics
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    - mcp__removed__daa_fault_tolerance
    - mcp__removed__health_check
    - mcp__removed__error_analysis
    - mcp__removed__diagnostic_run
