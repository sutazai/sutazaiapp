...
class SystemVerifier:
    ...
    def verify_os_compatibility(self):
        ...
        is_compatible = os_info["system"] == "Linux" and any(
            distro in os_info["distribution"] for distro in compatible_distros
        )
    ...
    def check_hardware_requirements(self):
        ...
        try:
            ...
            disk_space = shutil.disk_usage(self.project_root).free / (
                1024 * 1024 * 1024
            )  # GB
    ...
    def verify_software_dependencies(self):
        ...
        dependencies = {
            ...
            "docker_compose": self._run_command("docker-compose --version")[1]
            == 0,
    ...
    def check_network_connectivity(self):
        ...
        required_ports = {"postgres": 5432, "redis": 6379, "api": 8000}
        ...
        for service, port in required_ports.items():
            ...
            try:
                ...
                network_checks[service] = (
                    result == 0 or result == 111
                )  # 111 means address already in use
            except Exception:
