        ...
        for req, rem in remediations[pkg].items():
            ...
            if fix_version:
                ...
                remediation_styled = click.style(
                    f"{raw_recommendation} {other_options_msg}",
                    bold=True,
                    fg="green",
                )
...
def build_report_for_review_vuln_report(
    ...
    action_executed = [
        ...
        {
            "style": True,
            "value": report_from_file.get("scan_target", "-") + ":",
        },
    ]
...
def get_report_brief_info(
    ...
    if policy_file and policy_file.get("filename", False):
        safety_policy_used = [
            ...
            {
                "style": True,
                "value": " {0}".format(policy_file.get("filename", "-")),
            },
        ]
    ...
    if report_type == 1:
        ...
        additional_data = [
            [
                {
                    "style": True,
                    "value": str(brief_data["vulnerabilities_found"]),
                },
                {
                    "style": True,
            ...
            [
                {
                    "style": True,
                    "value": str(brief_data["vulnerabilities_ignored"]),
                },
                {
                    "style": True,
