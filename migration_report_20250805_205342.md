...
| sutazai-config-service | sutazai-config-service | 10041 | 11031 | docker-compose.external-integration.yml |
...
| pool-manager | ollama-pool-manager | 8081 | 11068 | docker-compose.ollama-cluster-optimized.yml |
