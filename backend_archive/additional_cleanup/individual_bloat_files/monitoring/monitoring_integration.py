...
class MonitoringSystem:
    ...
    def start_background_monitoring(self) -> None:
        ...
        if self._monitoring_active:
            self.logger.info("Background monitoring already active.")
            return
    ...
    def stop_background_monitoring(self) -> None:
        ...
        if not self._monitoring_active:
            self.logger.info("Background monitoring already stopped.")
            return
    ...
    def _add_monitoring_endpoints(self, app: FastAPI) -> None:
        ...
        async def get_monitoring_status():
            ...
            status: Dict[str, Any] = {
                ...
                "components_enabled": list(self.components.keys()),
                "components": {}, # Initialize as empty dict
            }
    ...
    def check_ethical_boundary(
        ...
        # Workaround for mypy potentially misinterpreting dynamic access
        return self.components["ethics"].check_decision(boundary_id, value, context) # type: ignore[no-any-return]
