...
Avoid comments like // TODO: automatedly scale this later or // imagine this uses a future AI module. If it doesn't exist now, it doesn't go in the codebase.
...
✨ **Forbidden:**
- Terms like configuration toolService, magicHandler, teleportData(), or comments such as // TODO: add telekinesis here.
...
✅ **Pre-Commit Checks:**
- Search for banned keywords (magic, configuration tool, black-box, etc.) in your diff.
